	...
	?>
		...
		if(!empty($product_id)){
			?>
			<h4>Product : <?php echo $this->crud_global->GetField('pmm_product',array('id'=>$product_id),'product');?></h4>
		        ...
		        if(!empty($arr)){
		            foreach ($arr as $val) {
			            ...
			            <tr>
				            ...
				            <th ><?php echo $val['name'];?></th>
				            <th class="text-center"><?php echo $val['measure'];?></th>
				            <th class="text-right"><?php echo number_format($val['total_before'],2,',','.');?></th>
				            <th class="text-right"><?php echo number_format($val['total_now'],2,',','.');?></th>
				            <th class="text-right"><?php echo number_format($val['total_before'] + $val['total_now'],2,',','.');?></th>
				        </tr>
			            <?php
			            $no++;
			            $total_before += $val['total_before'];
		        ...
		        if(!empty($arr)){
		            foreach ($arr as $val) {
			            ...
			            <tr>
				            ...
				            <th class="text-center"><?php echo $val['measure'];?></th>
				            <th class="text-right"><?php echo number_format($val['volume_now'],2,',','.');?></th>
				            <th class="text-right"><span class="pull-left">Rp.</span> <?php echo number_format($val['total_now'],2,',','.');?></th>
				        </tr>
			            <?php
			            $no++;
			            $total_now += $val['volume_now'];
