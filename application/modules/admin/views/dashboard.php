        ...
        <div class="wrap-dashboard">
            ...
            <div class="page-body">
                <div id="about" class="container spacer about">
                    <div class="col-sm-12" style="background-image:linear-gradient(to right,#999999 0%,#333333 51%,#666666 100%); font-size:18px; border-radius: 10px; padding:10px; margin-bottom:50px;">
                        ...
                        <div class="process">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <?php
                                    if(in_array($this->session->userdata('admin_group_id'), array(6,9))){
                                    ?>
                                    <th width="25%" class="text-center">
                                        <ul class="row text-center list-inline  wowload bounceInUp collapse" id="rencana">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <?php
                                    if(in_array($this->session->userdata('admin_group_id'), array(2,3,4,5,6,7,8,9))){
                                    ?>
                                    <th width="25%" class="text-center">
