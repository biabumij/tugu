...
class Themes_options extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->load->model(array('admin/m_admin','admin/Templates','crud_global','m_themes','m_pages'));
	...
	function index()
	{
		...
		if($check == true){		
	    	...
	    	if(!empty($id)){
	    		...
	    		$site_description = $this->filter->FilterInput($this->input->post('site_description'));
	            ...
	            $site_maps = $this->filter->FilterInput($this->input->post('site_maps'));
