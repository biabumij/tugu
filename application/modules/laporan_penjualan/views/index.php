                                                        ...
                                                        <table class="mytable table table-hover table-center table-bordered" id="monitoring-piutang" style="display:none; font-size: 11px;" width="100%";>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" colspan="4">PENERIMAAN</th>
                        ...
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    ...
                                    $.each(val.mats, function(a, row) {
                                        var a_no = a + 1;
                                        $('#monitoring-piutang tbody').append('<tr style="display:none;" class="mats-' + val.no + '"><td class="text-center"></td><td class="text-left">' + row.subject + '</td><td class="text-left">' + row.nomor_invoice + '</td><td class="text-right">' + row.tanggal_invoice + '</td><td class="text-right">' + row.dpp_tagihan + '</td><td class="text-right">' + row.ppn_tagihan + '</td><td class="text-right">' + row.jumlah_tagihan + '</td><td class="text-right">' + row.dpp_pembayaran + '</td><td class="text-right">' + row.ppn_pembayaran + '</td><td class="text-right">' + row.pph_pembayaran + '</td><td class="text-right">' + row.jumlah_pembayaran + '</td><td class="text-right">' + row.dpp_sisa_piutang + '</td><td class="text-right">' + row.ppn_sisa_piutang + '</td><td class="text-right">' + row.jumlah_sisa_piutang + '</td><td class="text-right">' + row.status_pembayaran + '</td><td class="text-center">' + row.syarat_pembayaran + '</td></tr>');   
                                    });
