...
<?php
    ...
    ?>
    <div class="col-sm-2">
    <button style="background-color:#88b93c; border:1px solid black; border-radius:10px; line-height:30px;"><a href="<?php echo site_url('produksi/form_rakor'); ?>"><b style="color:white;">BUAT KUNCI DATA RAKOR</b></a></button>
    </div>
    <?php
    }
    ?>
