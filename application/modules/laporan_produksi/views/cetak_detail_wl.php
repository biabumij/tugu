	...
	<body>
		...
		<table width="98%" border="0" cellpadding="3" border="0">
			...
			<tr class="table-baris1">		
				...
				<th align="right" style="border-bottom:1px solid black;"><?php echo number_format($vol_pemeliharaan_wheel_loader,2,',','.');?></th>
				<th align="right" style="border-bottom:1px solid black;"><?php echo number_format($harsat_pemeliharaan_wheel_loader,0,',','.');?></th>
				<th align="right" style="border-bottom:1px solid black; border-right:1px solid black;"><?php echo number_format($pemeliharaan_wheel_loader,0,',','.');?></th>
				...
				<th align="right" style="border-bottom:1px solid black; border-right:1px solid black;"><?php echo number_format($total_pemakaian_pemeliharaan_wheel_loader,0,',','.');?></th>
				<?php
				$styleColor = $total_vol_evaluasi_pemeliharaan_wheel_loader < 0 ? 'color:red' : 'color:black';
				?>
				<th align="right" style="<?php echo $styleColor ?>; border-bottom:1px solid black;"><?php echo $total_vol_evaluasi_pemeliharaan_wheel_loader < 0 ? "(".number_format(-$total_vol_evaluasi_pemeliharaan_wheel_loader,2,',','.').")" : number_format($total_vol_evaluasi_pemeliharaan_wheel_loader,2,',','.');?></th>
				<?php
				$styleColor = $total_nilai_evaluasi_pemeliharaan_wheel_loader < 0 ? 'color:red' : 'color:black';
				?>
				<th align="right" style="<?php echo $styleColor ?>; border-bottom:1px solid black; border-right:1px solid black;"><?php echo $total_nilai_evaluasi_pemeliharaan_wheel_loader < 0 ? "(".number_format(-$total_nilai_evaluasi_pemeliharaan_wheel_loader,0,',','.').")" : number_format($total_nilai_evaluasi_pemeliharaan_wheel_loader,0,',','.');?></th>
	        </tr>
	    </table>
